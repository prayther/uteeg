# $Id: dir02.spec 824 2012-08-23 17:05:07Z sysutil $
Name:  dir02
Version:  .0.5
Release:  1%{?dist}
Summary:  openldap dir02 master
...
%description
role based configuration for the master openldap server dir02
...
# the reason this makes te dir02 directory is because that's what rsync does. 
rsync -av $RPM_BUILD_DIR/dir02/etc $RPM_BUILD_ROOT
