# $Id: dir03.spec 763 2012-08-15 13:52:46Z sysutil $
Name:  dir03
Version:  .0.3
Release:  1%{?dist}
Summary:  openldap dir03 master
...
%description
role based configuration for the master openldap server dir03
...
# the reason this makes te dir03 directory is because that's what rsync does. 
rsync -av $RPM_BUILD_DIR/dir03/etc $RPM_BUILD_ROOT
