# $Id: tomcat-all.spec 763 2012-08-15 13:52:46Z sysutil $
Name:  tomcat-all
Version:  .0.15
Release:  1%{?dist}
Summary:  tomcat-all system account for SVN and RPM build
Packager: Aaron Prayther aprayther@lce.com Life Cycle Engineering
Group: Development/Tools
License:  GPL
URL: https://software.forge.mil
Source:  tomcat-all.tar.gz
...
%description
The tomcat-all package delivers, RPM build tools, subversion and the ability to build "role" specific rpm's for services and applications.  Reading in hosts from the comma delimited file hosts.role.txt
...
mkdir -p $RPM_BUILD_ROOT/tomcat-all
rsync -av $RPM_BUILD_DIR/tomcat-all $RPM_BUILD_ROOT/home/
