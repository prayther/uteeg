...
#read
  cd /home/sysutil/redhat/SOURCES && find ./avvdat-* -exec rm {} \;

cd /home/sysutil/redhat/SOURCES && wget --reject $CURRENTAVVDAT -rnH --cut-dirs=3 ftp://ftp.mcafee.com/pub/datfiles/english/avvdat*.tar
  ...
  vi /home/sysutil/redhat/SPECS/avvdatspawar.spec

  cd /home/sysutil/redhat/SPECS && rpmbuild -bb avvdatspawar.spec
