...
rsync -av --exclude=".svn" $HOME/svn.forge.mil/slim/base/dev/rhel5/puppet/modules/$hostname/ $HOME/redhat/SOURCES/puppet-$hostname/etc/puppet/modules/$hostname/
chown -R sysutil.sysutil $HOME/
rsync -av --exclude=".svn" $HOME/svn.forge.mil/slim/base/dev/rhel5/puppet/trunk/etc/puppet/modules/hosts/defaults.custom.rpm/templates/ $hostname $HOME/redhat/SOURCES/puppet-$hostname/etc/puppet/modules/$hostname/templates/
