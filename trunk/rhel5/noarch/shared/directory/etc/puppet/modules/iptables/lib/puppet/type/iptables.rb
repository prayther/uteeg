...
module Puppet
  ...
  # This @@ syntax means that this variable is accessible outside this host.
  @@rules = {}
  ...
  # Here we define the type and all of it's parameters
  newtype(:iptables) do
    ...
    # This function name is different in 0.25.5 versions.  it was "def evaluate".  This
    # is the function that is run when the changes are actually applied to the system
    def properties
