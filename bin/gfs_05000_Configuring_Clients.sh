...
ssh rhel-client.prayther.org "mount -o acl -t glusterfs gfs-node1:/labvol /mnt/labvol"
...
doit ssh rhel-client.prayther.org "mount -o acl -t glusterfs gfs-node1:/labvol /mnt/labvol"
