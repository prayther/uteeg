...
#fstab entry
ssh gfs-admin.prayther.org "grep brick-11 /etc/fstab || echo /dev/rhs_vg/brick-11 /bricks/brick-11 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-admin.prayther.org "grep brick-12 /etc/fstab || echo /dev/rhs_vg/brick-12 /bricks/brick-12 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-admin.prayther.org "grep brick-13 /etc/fstab || echo /dev/rhs_vg/brick-13 /bricks/brick-13 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-admin.prayther.org "grep brick-14 /etc/fstab || echo /dev/rhs_vg/brick-14 /bricks/brick-14 xfs defaults 1 2 >> /etc/fstab"

ssh gfs-node1.prayther.org "grep brick-21 /etc/fstab || echo /dev/rhs_vg/brick-21 /bricks/brick-21 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node1.prayther.org "grep brick-22 /etc/fstab || echo /dev/rhs_vg/brick-22 /bricks/brick-22 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node1.prayther.org "grep brick-23 /etc/fstab || echo /dev/rhs_vg/brick-23 /bricks/brick-23 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node1.prayther.org "grep brick-24 /etc/fstab || echo /dev/rhs_vg/brick-24 /bricks/brick-24 xfs defaults 1 2 >> /etc/fstab"

ssh gfs-node2.prayther.org "grep brick-31 /etc/fstab || echo /dev/rhs_vg/brick-31 /bricks/brick-31 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node2.prayther.org "grep brick-32 /etc/fstab || echo /dev/rhs_vg/brick-32 /bricks/brick-32 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node2.prayther.org "grep brick-33 /etc/fstab || echo /dev/rhs_vg/brick-33 /bricks/brick-33 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node2.prayther.org "grep brick-34 /etc/fstab || echo /dev/rhs_vg/brick-34 /bricks/brick-34 xfs defaults 1 2 >> /etc/fstab"

ssh gfs-node3.prayther.org "grep brick-41 /etc/fstab || echo /dev/rhs_vg/brick-41 /bricks/brick-41 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node3.prayther.org "grep brick-42 /etc/fstab || echo /dev/rhs_vg/brick-42 /bricks/brick-42 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node3.prayther.org "grep brick-43 /etc/fstab || echo /dev/rhs_vg/brick-43 /bricks/brick-43 xfs defaults 1 2 >> /etc/fstab"
ssh gfs-node3.prayther.org "grep brick-44 /etc/fstab || echo /dev/rhs_vg/brick-44 /bricks/brick-44 xfs defaults 1 2 >> /etc/fstab"
#mount
