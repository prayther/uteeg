...
#LV virtualsize
ansible gfs-admin.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-11"
ansible gfs-admin.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-12"
ansible gfs-admin.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-13"
ansible gfs-admin.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-14"
#ssh gfs-admin.prayther.org for i in {1..4}; do lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-1${i};done
ansible gfs-node1.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-21"
ansible gfs-node1.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-22"
ansible gfs-node1.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-23"
ansible gfs-node1.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-24"
#ssh gfs-node1.prayther.org for i in {1..4}; do lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-2${i};done
ansible gfs-node2.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-31"
ansible gfs-node2.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-32"
ansible gfs-node2.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-33"
ansible gfs-node2.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-34"
#ssh gfs-node2.prayther.org for i in {1..4}; do lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-3${i};done
ansible gfs-node3.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-41"
ansible gfs-node3.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-42"
ansible gfs-node3.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-43"
ansible gfs-node3.prayther.org -a "lvcreate -V 2G -T rhs_vg/rhs_pool -n brick-44"
...
ssh gfs-admin.prayther.org "ls /bricks/brick-11/brick || mkdir -p /bricks/brick-11/brick"
ssh gfs-admin.prayther.org "ls /bricks/brick-12/brick || mkdir -p /bricks/brick-12/brick"
ssh gfs-admin.prayther.org "ls /bricks/brick-13/brick || mkdir -p /bricks/brick-13/brick"
ssh gfs-admin.prayther.org "ls /bricks/brick-14/brick || mkdir -p /bricks/brick-14/brick"

ssh gfs-node1.prayther.org "ls /bricks/brick-21/brick || mkdir -p /bricks/brick-21/brick"
ssh gfs-node1.prayther.org "ls /bricks/brick-22/brick || mkdir -p /bricks/brick-22/brick"
ssh gfs-node1.prayther.org "ls /bricks/brick-23/brick || mkdir -p /bricks/brick-23/brick"
ssh gfs-node1.prayther.org "ls /bricks/brick-24/brick || mkdir -p /bricks/brick-24/brick"

ssh gfs-node2.prayther.org "ls /bricks/brick-31/brick || mkdir -p /bricks/brick-31/brick"
ssh gfs-node2.prayther.org "ls /bricks/brick-32/brick || mkdir -p /bricks/brick-32/brick"
ssh gfs-node2.prayther.org "ls /bricks/brick-33/brick || mkdir -p /bricks/brick-33/brick"
ssh gfs-node2.prayther.org "ls /bricks/brick-34/brick || mkdir -p /bricks/brick-34/brick"

ssh gfs-node3.prayther.org "ls /bricks/brick-41/brick || mkdir -p /bricks/brick-41/brick"
ssh gfs-node3.prayther.org "ls /bricks/brick-42/brick || mkdir -p /bricks/brick-42/brick"
ssh gfs-node3.prayther.org "ls /bricks/brick-43/brick || mkdir -p /bricks/brick-43/brick"
ssh gfs-node3.prayther.org "ls /bricks/brick-44/brick || mkdir -p /bricks/brick-44/brick"
#semanage
