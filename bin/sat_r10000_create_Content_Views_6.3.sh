...
repolistrhel() { for i in $(hammer --csv repository list --organization="${ORG}" | grep -v EPEL | grep -v "Red Hat Satellite Capsule" | grep -v "Red Hat Satellite 6.3" | grep -v Collections | grep -v Optional | grep -v Extras | grep -v Kickstart | awk -F, {'print $1'} | grep -v Id | sort -n)
...
repolistcap () {  for i in $(hammer --csv repository list --organization="${ORG}" | grep -v EPEL | grep -v "Red Hat Satellite 6.3" | grep -v Optional | grep -v Extras | grep -v Kickstart | awk -F, {'print $1'} | grep -v Id | sort -n)
...
repolistextras() { for i in $(hammer --csv repository list --organization="${ORG}" | grep -v Kickstart | grep -v Collections | grep -v "Red Hat Satellite 6.3" | grep -v "Red Hat Satellite Capsule" | awk -F, {'print $1'} | grep -v Id | sort -n)
